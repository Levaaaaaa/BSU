...
//        editButtonsPanel.add(editDataField);
    ...
    private void saveChanges(File file) {
        ...
        /*
        currentGoods.setName(setGoodsName.getText());
        currentGoods.setImportCountry(setGoodsImporter.getText());
        currentGoods.setCount((int)setGoodsCount.getValue());
        */
    ...
    private void initEditPanel() {
        ...
        //editButtonsPanel.add(editButton);
